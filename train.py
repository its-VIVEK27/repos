...
if __name__ == "__main__":
    ...
    # This will depend on your model's architecture. 
    # Typically, you'd replace the layer names below with the last two layers of your model.

    # Example:
    for name, param in list(net.named_parameters())[-2:]:
        param.requires_grad = True  # Unfreeze only the last two layers

    # Now, only the last two layers have requires_grad=True and will be trained
